...
namespace QuanLyNhanSu
{
    ...
    {
        // Chuỗi kết nối SQL Server dùng cho các Stored Procedure.
        // Nếu null => con = new SqlConnection(null) => Load sẽ lỗi.
        public static string chuoiketnoi = @"Server=LAPTOP-KT6FR8DE\SQLEXPRESS;Database=QLNS_DA;Integrated Security=True;TrustServerCertificate=True";
