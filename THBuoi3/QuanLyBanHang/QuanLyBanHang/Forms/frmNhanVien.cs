    ...
    public partial class frmNhanVien : Form
    {
        ...
        private void frmNhanVien_Load(object sender, EventArgs e)
        {
            ...
            txtHoVaTen.DataBindings.Add(
                "Text", bindingSource, "HoVaTen", false, DataSourceUpdateMode.Never);

            txtDienThoai.DataBindings.Clear();
            txtDienThoai.DataBindings.Add(
                "Text", bindingSource, "DienThoai", false, DataSourceUpdateMode.Never);

            txtDiaChi.DataBindings.Clear();
            txtDiaChi.DataBindings.Add(
                "Text", bindingSource, "DiaChi", false, DataSourceUpdateMode.Never);

            txtTenDangNhap.DataBindings.Clear();
            txtTenDangNhap.DataBindings.Add(
                "Text", bindingSource, "TenDangNhap", false, DataSourceUpdateMode.Never);

            // ComboBox quyền hạn
            cboQuyenHan.DataBindings.Clear();
            cboQuyenHan.DataBindings.Add(
                "SelectedItem", bindingSource, "QuyenHan", false, DataSourceUpdateMode.Never);
