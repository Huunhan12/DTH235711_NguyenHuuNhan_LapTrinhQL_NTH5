...
namespace QuanLyBanHang.Reports
{
    public partial class FrmThongKeSanPham : Form
    {
        ...
        {
            var loaiSanPham = context.LoaiSanPham
                .Select(r => new { r.ID, r.TenLoai })
                .ToList();

            cboLoaiSanPham.DataSource = loaiSanPham;
            cboLoaiSanPham.DisplayMember = "TenLoai";
            cboLoaiSanPham.ValueMember = "ID";
            cboLoaiSanPham.SelectedIndex = -1; // Bỏ trống ban đầu
        }
        public void LayHangSanXuatVaoComboBox()
        {
            var hangSanXuat = context.HangSanXuat
                .Select(r => new { r.ID, r.TenHangSanXuat })
                .ToList();

            cboHangSanXuat.DataSource = hangSanXuat;
            cboHangSanXuat.DisplayMember = "TenHangSanXuat";
            cboHangSanXuat.ValueMember = "ID";
            cboHangSanXuat.SelectedIndex = -1; // Bỏ trống ban đầu
        }
